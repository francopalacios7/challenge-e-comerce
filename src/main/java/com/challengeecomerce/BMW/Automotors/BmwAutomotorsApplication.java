...
public class BmwAutomotorsApplication {
	...
	public CommandLineRunner initData(ClientRepository clientRepository, CarRepository carRepository, ModRepository modRepository ) {
		return (args -> {
			...
			Car car4 = new Car("BMW X6", LocalDate.of(2023, 3, 15), CarColor.BLACK, 120000.0,
			...
			Car car5 = new Car("BMW M5", LocalDate.of(2023, 5, 20), CarColor.WHITE, 135000.0,
...
// Crear moto2 (BMW R1250GS)
			Car moto2 = new Car("BMW R1250GS", LocalDate.of(2023, 4, 10), CarColor.BLUE, 23000.0,
					...
					Arrays.asList("https://i.postimg.cc/RFbZS9M6/r1250-0.webp",
...
// Crear moto3 (BMW G310GS)
			Car moto3 = new Car("BMW G310GS", LocalDate.of(2023, 6, 5), CarColor.WHITE, 9000.0,
					...
					Arrays.asList("https://i.postimg.cc/Hsb82cY6/g310-0.webp",
